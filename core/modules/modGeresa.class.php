 ...
 */
class modGeresa extends DolibarrModules
{
	/**
	...
	function __construct($db)
	{
		...
		$this->description = "Gestion des réservations";
		...
		$this->picto='geresa/img/mymodule.png';
		...
		$this->langfiles = array("geresa/langs/fr_FR");
